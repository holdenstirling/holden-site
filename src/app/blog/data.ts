...
export const blogData: Record<string, BlogPost> = {
  ...
  "client-retention-at-scale": {
    ...
    sections: [
      ...
      { heading: "Process consistency", text: "The third factor is process. Every engagement follows the same playbook for scoping, kickoff, delivery, QA, and launch. This consistency means clients always know what to expect and we rarely miss deadlines. I built every one of these processes from scratch when we started Arc4." },
  ...
  "scaling-strategies": {
    ...
    sections: [
      { text: "When my co-founder and I started Arc4 we had zero clients, zero processes, and zero infrastructure. Two years later we are at $3.5M in revenue with 17 people across three teams. Here is what I learned about scaling a services business fast." },
      { heading: "Systematize before scaling", text: "The first lesson is that you cannot scale what you have not systematized. Before hiring anyone beyond the two of us, I documented every delivery process end to end. Scoping templates, project kickoff checklists, QA workflows, client communication cadences. These became our playbook and every new hire onboards through them." },
  ...
  "yext-to-arc4": {
    ...
    sections: [
      { text: "I spent 8 years at Yext. I was promoted 5 times. I made President's Club multiple years. I led a $2.5M implementation with Optum Health. By any measure it was a great run. And then I left to start something from nothing." },
