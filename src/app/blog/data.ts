...
export const blogData: Record<string, BlogPost> = {
  ...
  "client-retention-at-scale": {
    ...
    sections: [
      ...
      { heading: "Process consistency", text: "The third factor is process. Every engagement follows a consistent process from kickoff through launch. Clients always know what to expect and we rarely miss deadlines. I built these processes from scratch when we started the company." },
  ...
  "scaling-strategies": {
    ...
    description: "Lessons learned scaling a company from nothing in under two years.",
    tag: "Business", date: "2026-02-01", readingTime: 5,
    related: ["client-retention-at-scale", "yext-to-arc4"],
    sections: [
      { text: "When my co-founder and I started the company we had zero clients, zero processes, and zero infrastructure. Two years later we had a growing team across multiple departments and more work than we could handle. Here is what I have learned about scaling a services business fast." },
      ...
      { heading: "The hardest transition", text: "The hardest part of scaling was the transition from doing everything myself to managing people who do the work. The day I realized my job was to make my team successful rather than to be the best individual contributor was the company started growing faster than I could have grown it alone." },
    ],
  },
  "yext-to-arc4": {
    title: "From Corporate to Co-Founder: The Journey",
    description: "Why I left a stable role to co-found a company, and what I learned along the way.",
    ...
    sections: [
      ...
      { heading: "Patience paid off", text: "Looking back I would not change anything about the timing. 8 years at Yext gave me the technical depth, the enterprise relationships, and the operational instincts that made the leap possible. If I had left after 3 years I would not have been ready. The patience paid off." },
    ],
  },
  "ironman-business-lessons": {
    ...
    sections: [
      { text: "I have finished 5 Ironmans. People always ask what it teaches you about business and the honest answer is: more than any book, course, or MBA I have ever come across." },
  ...
  "90-days-solo-travel": {
    ...
    sections: [
      { text: "Before co-founding I took 90 days and traveled solo through 15 countries. It was the best investment I have ever made in myself and the lessons I brought back shaped how I run my company today." },
