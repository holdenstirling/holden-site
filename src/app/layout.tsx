...
export const metadata: Metadata = {
  ...
  description:
    "Technical co-founder who scaled a company from zero. 50+ Fortune 500 implementations. Claude API developer. Solutions architect. 5x Ironman finisher. Denver, CO.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Co-founded and scaled a company from zero. 50+ Fortune 500 implementations. Claude API developer. 5x Ironman finisher.",
  ...
  icons: { icon: [{ url: "/favicon.ico" }, { url: "/favicon-32.png", sizes: "32x32", type: "image/png" }, { url: "/favicon-192.png", sizes: "192x192", type: "image/png" }], apple: "/apple-touch-icon.png" },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=DM+Sans:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;600&display=swap" />
