...
const faqData = [
  {q:"What does Holden Ottolini do?",a:"I am the Co-Founder and VP of Operations & Services at Arc4, a technical services company I grew to $3.5M in revenue with a 17 person team. I deliver enterprise implementations for Fortune 500 clients including American Eagle, Kidde (Carrier Global), and Aspirus Healthcare."},
  ...
  {q:"What is Holden's background before Arc4?",a:"8 years at Yext. Promoted 5 times from Enterprise Sales Coordinator to Senior Solutions Architect. Made President's Club multiple years. Led a $2.5M implementation with Optum Health."},
  {q:"What technologies does Holden work with?",a:"Python and Claude API daily. React, Next.js, TypeScript, Vercel. CMS platforms: WordPress, Contentful, Sanity, Drupal. Also ChatGPT, Gemini, REST APIs, AWS, Jira, HubSpot, Tempo, and Slack integrations."},
  {q:"What makes Arc4 different?",a:"Every one of our 50+ engagements was net new business. 96% client retention. 70% of revenue from expansions. I built production internal tools including a real time ops dashboard integrating Slack, Tempo, Zoom, HubSpot, and Jira."},
...
const metrics=[{n:"$3.5M",l:"Revenue Built",s:"from zero in <2 years"},{n:"50+",l:"Implementations",s:"Fortune 500 clients"},{n:"96%",l:"Client Retention",s:"across all accounts"},{n:"5x",l:"Ironman Finisher",s:"PR 11:09, 11th in AG"}];
const clients=["American Eagle","Kidde (Carrier Global)","Aspirus Healthcare","Optum Health","Child Development Schools"];
const timeline=[{yr:"2023 \u2014 Present",t:"Co-Founder & VP of Operations & Services",co:"Arc4",loc:"Denver, CO",pts:["Grew from zero to $3.5M revenue and 17 people in under two years","$1.5M Kidde (Carrier Global) rollout: React, Next.js, multi national deployment","Implementations for American Eagle, Aspirus Healthcare, Child Development Schools, 50+ others","Built real time ops dashboard integrating Slack, Tempo, Zoom, HubSpot, Jira","Python and Claude API code daily for production internal and client tools","Manage 3 teams: SEO/AIO, Development, PM/Design"]},{yr:"2019 \u2014 2023",t:"Senior Solutions Architect",co:"Yext",loc:"Washington, D.C.",pts:["$2.5M Optum Health implementation \u2014 largest healthcare AI search deployment in company history","Technical pre sales: API architecture, POCs, C suite presentations","Multiple President\u2019s Club awards, top SA, off cycle promotions","Created integration frameworks adopted org wide, mentored junior architects"]},{yr:"2015 \u2014 2019",t:"4 Roles, 4 Promotions",co:"Yext",loc:"NYC & D.C.",pts:["SA Partnerships \u2014 enabled agency and tech partners (NYC)","Solutions Engineer \u2014 live demos and POCs for enterprise (D.C.)","Technical Project Manager \u2014 10+ concurrent implementations (NYC)","Enterprise Sales Coordinator \u2014 first job, promoted within a year (NYC)"]}];
...
const techStack=[{cat:"Daily Use",items:["Python","Claude API","React","Next.js","TypeScript","Vercel"]},{cat:"CMS",items:["WordPress","Contentful","Sanity","Drupal"]},{cat:"AI / LLM",items:["Claude API","ChatGPT","Gemini","Prompt Eng.","LLM Eval"]},{cat:"Infra",items:["Vercel","Netlify","AWS","REST APIs","Git"]},{cat:"Enterprise",items:["Solution Arch.","Pre Sales","API Design","Multi National"]},{cat:"Tools",items:["Conductor","Jira","HubSpot","Tempo","Slack APIs"]}];
const speakingTopics=[{title:"The Rise of AI for Small Businesses",desc:"How local businesses can prepare for AI search and LLMs. Presented at Localogy L25.",tag:"AI"},{title:"Building from Zero",desc:"Starting a company from nothing and scaling to $3.5M with no playbook.",tag:"Founder"},{title:"Enterprise Implementation at Scale",desc:"Lessons from 50+ Fortune 500 implementations.",tag:"Enterprise"},{title:"Mountains, Ironmans, and Business",desc:"What 5 Ironman finishes taught me about performing under pressure.",tag:"Personal"},{title:"AI Search and Local SEO Strategy",desc:"Visibility across ChatGPT, Claude, Perplexity, and Google AI.",tag:"AI"},{title:"Scaling Teams in Ambiguity",desc:"Building a 17 person team when no process or precedent exists.",tag:"Leadership"}];
          ...
          <div style={{position:"relative",maxWidth:1100,margin:"0 auto",padding:"120px 24px 80px",width:"100%"}}>
            <div className="g2" style={{display:"grid",gridTemplateColumns:"1fr auto",gap:50,alignItems:"center"}}>
              <div>
                ...
                <Rv delay={200}><P style={{maxWidth:520,margin:"0 0 36px",fontSize:16}}>From selling pumpkins at 14 to scaling a $3.5M company with 17 people. I write Claude API code in the morning, present to Fortune 500 executives in the afternoon, and manage my team in between.</P></Rv>
        ...
        <section id="about" style={{padding:"90px 24px",maxWidth:1100,margin:"0 auto"}}><Rv><Lbl>About</Lbl></Rv>
          <div className="g2" style={{display:"grid",gridTemplateColumns:"1.2fr 1fr",gap:50,alignItems:"start"}}>
            <div>
              ...
              <Rv delay={200}><P style={{marginBottom:14}}>I started my first business at 14 selling pumpkins in upstate New York. Almost failed out of college. Ended up in NYC, got promoted 5 times in 8 years at Yext, made President's Club multiple years, closed a $2.5M deal with Optum Health, and eventually left to co-found Arc4.</P></Rv>
              <Rv delay={300}><P>Today I run a 17 person team delivering implementations for American Eagle, Kidde (Carrier Global), Aspirus Healthcare, and 50+ other enterprise clients. I write production code with Python and the Claude API every day. Outside of work I have finished 5 Ironmans, climb mountains, and spent 90 days traveling solo through 15 countries.</P></Rv>
            </div>
            <Rv delay={200}><aside style={{background:"rgba(200,149,108,0.04)",border:"1px solid rgba(200,149,108,0.1)",borderRadius:14,padding:24}}>
              ...
              {[["Current","Co-Founder & VP, Arc4"],["Revenue","$3.5M from zero"],["Team","17 people, 3 teams"],["Biggest Deal","$2.5M (Optum Health)"],["Biggest Project","$1.5M (Kidde / Carrier)"],["Yext","5 promotions, 8 years"],["President\u2019s Club","Multiple years"],["Ironman","5x finisher, PR 11:09"],["Location","Denver, Colorado"],["Education","Binghamton University"]].map(([k,v])=><div key={k} style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${FAINT}`}}><span style={{fontSize:11,fontFamily:SN,color:"rgba(232,228,221,0.3)"}}>{k}</span><span style={{fontSize:11,fontFamily:SN,fontWeight:600,color:"rgba(232,228,221,0.7)"}}>{v}</span></div>)}
            </aside></Rv>
          </div>
        </section>
