...
const metrics=[{n:"Multi $M",l:"Revenue Built",s:"co-founded, scaled from zero"},{n:"50+",l:"Implementations",s:"Fortune 500 clients"},{n:"96%",l:"Client Retention",s:"across all accounts"},{n:"5x",l:"Ironman Finisher",s:"PR 11:09, 11th in AG"}];
const clients=["Fortune 500 Retail","Global Manufacturing","Healthcare Networks","Enterprise Healthcare","Education"];
const timeline=[{yr:"2023 \u2014 Present",t:"Co-Founder & VP of Operations & Services",co:"Arc4",loc:"Denver, CO",pts:["Co-founded and grew from zero to a multi million dollar run rate and 17 people in under two years","Led a seven figure platform rollout for a global manufacturing brand: React, Next.js, multi national deployment","Delivered 50+ enterprise implementations for Fortune 500 clients across retail, healthcare, education, and manufacturing","Built real time ops dashboard integrating Slack, Tempo, Zoom, HubSpot, Jira","Python and Claude API code daily for production internal and client tools","Manage 3 teams: SEO/AIO, Development, PM/Design"]},{yr:"2019 \u2014 2023",t:"Senior Solutions Architect",co:"Yext",loc:"Washington, D.C.",pts:["Led one of the largest healthcare AI search and provider search deployments in the company \u2014 largest healthcare AI search deployment in company history","Technical pre sales: API architecture, POCs, C suite presentations","Multiple President\u2019s Club awards, top SA, off cycle promotions","Created integration frameworks adopted org wide, mentored junior architects"]},{yr:"2015 \u2014 2019",t:"4 Roles, 4 Promotions",co:"Yext",loc:"NYC & D.C.",pts:["SA Partnerships \u2014 enabled agency and tech partners (NYC)","Solutions Engineer \u2014 live demos and POCs for enterprise (D.C.)","Technical Project Manager \u2014 10+ concurrent implementations (NYC)","Enterprise Sales Coordinator \u2014 first job, promoted within a year (NYC)"]}];
        ...
        <section id="about" style={{padding:"90px 24px",maxWidth:1100,margin:"0 auto"}}><Rv><Lbl>About</Lbl></Rv>
          <div className="g2" style={{display:"grid",gridTemplateColumns:"1.2fr 1fr",gap:50,alignItems:"start"}}>
            ...
            <Rv delay={200}><aside style={{background:"rgba(200,149,108,0.04)",border:"1px solid rgba(200,149,108,0.1)",borderRadius:14,padding:24}}>
              ...
              {[["Current","Co-Founder & VP, Arc4"],["Revenue","Multi $M from zero"],["Team","17 people, 3 teams"],["Biggest Deal","Seven figures"],["Biggest Project","Seven figures"],["Yext","5 promotions, 8 years"],["President\u2019s Club","Multiple years"],["Ironman","5x finisher, PR 11:09"],["Location","Denver, Colorado"],["Education","Binghamton University"]].map(([k,v])=><div key={k} style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${FAINT}`}}><span style={{fontSize:11,fontFamily:SN,color:"rgba(232,228,221,0.3)"}}>{k}</span><span style={{fontSize:11,fontFamily:SN,fontWeight:600,color:"rgba(232,228,221,0.7)"}}>{v}</span></div>)}
            </aside></Rv>
          </div>
        </section>
