...
const speakingEvents = [{"@context":"https://schema.org","@type":"Event",name:"The Rise of AI for Small Businesses",description:"How local businesses can prepare for AI search, LLMs, and the shifting digital landscape.",startDate:"2025-02-18",eventStatus:"https://schema.org/EventScheduled",eventAttendanceMode:"https://schema.org/OfflineEventAttendanceMode",performer:{"@type":"Person",name:"Holden Stirling Ottolini"},organizer:{"@type":"Organization",name:"Localogy",url:"https://www.localogy.com"},location:{"@type":"Place",name:"Localogy L25 Conference",address:{"@type":"PostalAddress",addressLocality:"Columbus",addressRegion:"OH",addressCountry:"US"}}},{"@context":"https://schema.org","@type":"Event",name:"Achieve Podcast Guest Appearance",description:"Interview on building companies, AI search, and lessons from endurance sports.",startDate:"2025-02-18",eventStatus:"https://schema.org/EventScheduled",eventAttendanceMode:"https://schema.org/OnlineEventAttendanceMode",performer:{"@type":"Person",name:"Holden Stirling Ottolini"},organizer:{"@type":"Organization",name:"Achieve Podcast",url:"https://holdenottolini.com"},location:{"@type":"VirtualLocation",url:"https://holdenottolini.com"}}];

const faqData = [
  {q:"What does Holden Ottolini do?",a:"I am the Co-Founder and VP of Operations & Services at Arc4, a technical services company we built from zero to a growing team. We deliver enterprise implementations for Fortune 500 clients across CMS, search, and digital experience platforms."},
...
const speakingTopics=[{title:"The Rise of AI for Small Businesses",desc:"How local businesses can prepare for AI search and LLMs. Presented at Localogy L25.",tag:"AI"},{title:"Building from Zero",desc:"What it actually looks like to build something from zero. No playbook, no safety net, no plan B.",tag:"Founder"},{title:"Enterprise Implementation at Scale",desc:"Lessons from 50+ Fortune 500 implementations.",tag:"Enterprise"},{title:"Mountains, Ironmans, and Business",desc:"What 5 Ironman finishes taught me about performing under pressure.",tag:"Personal"},{title:"AI Search and Local SEO Strategy",desc:"Visibility across ChatGPT, Claude, Perplexity, and Google AI.",tag:"AI"},{title:"Scaling Teams in Ambiguity",desc:"When nothing exists yet and you have to build the plane while flying it.",tag:"Leadership"}];
        ...
        <section id="about" style={{padding:"90px 24px",maxWidth:1100,margin:"0 auto"}}><Rv><Lbl>About</Lbl></Rv>
          <div className="g2" style={{display:"grid",gridTemplateColumns:"1.2fr 1fr",gap:50,alignItems:"start"}}>
            ...
            <Rv delay={200}><aside style={{background:"rgba(200,149,108,0.04)",border:"1px solid rgba(200,149,108,0.1)",borderRadius:14,padding:24}}>
              ...
              {[["Current","Co-Founder & VP, Arc4"],["Team","Multiple teams"],["Yext","5 promotions, 8 years"],["President\u2019s Club","Multiple years"],["Ironman","5x finisher"],["Location","Denver, Colorado"],["Education","Binghamton University"]].map(([k,v])=><div key={k} style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${FAINT}`}}><span style={{fontSize:11,fontFamily:SN,color:"rgba(232,228,221,0.3)"}}>{k}</span><span style={{fontSize:11,fontFamily:SN,fontWeight:600,color:"rgba(232,228,221,0.7)"}}>{v}</span></div>)}
            </aside></Rv>
          </div>
        </section>
